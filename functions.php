...
if ( ! function_exists( 'my_project_setup' ) ) :
/**
...
endif; // my_project_setup
add_action( 'after_setup_theme', 'my_project_setup' );
 ...
 */
function my_project_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'my_project_content_width', 640 );
}
add_action( 'after_setup_theme', 'my_project_content_width', 0 );
...
function my_project_scripts() {
	...
	wp_enqueue_script( 'my-project-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'my-project-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
